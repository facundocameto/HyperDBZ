...
function loadHeader()
{
  ...
  <div class="container-fluid d-flex flex-md-row justify-content-around text-center pt-1">
    ...
    <div> <a class="hide-on-mobile py-2 navigation-bar pl-1 pr-1" href="movelist/movelist"> <img height="40rem" width="40rem" src="img/icons/anyP.png" alt=""> <span>MOVELIST</span></a></div>
    <div> <a class="hide-on-mobile py-2 navigation-bar pl-1 pr-1" href="credits"> <img height="40rem" width="25rem" src="img/icons/balthazar.png" alt=""> <span>CREDITS</span></a></div>
  </div>
